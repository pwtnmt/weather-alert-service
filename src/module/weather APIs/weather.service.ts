...
export class WeatherService {
  ...
  /**
   * ดึงข้อมูลสภาพอากาศปัจจุบันของเมือง
   * @param cityId ID ของเมือง
   * @returns WeatherResponseDto ข้อมูลสภาพอากาศ
   * @throws NotFoundException หากไม่พบเมือง
   * @throws InternalServerErrorException หากไม่สามารถดึงข้อมูลสภาพอากาศได้
   */
